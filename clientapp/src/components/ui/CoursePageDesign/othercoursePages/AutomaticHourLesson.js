...
/* ========================================================================
   MAIN PAGE
   ======================================================================== */
export default function AutomaticHourLesson() {
  ...
  useEffect(() => {
    dispatch(getCourseBySlug("automatic-hourly-lesson"));
  }, [dispatch]);
  ...
  const manualCategory = data.find((category) => category._id === "automatic");
  ...
  const hourPackages =
    manualCategory?.data?.filter((product) => {
      ...
      return name.includes("hour automatic") || name.includes("hours automatic")|| name.includes("hours") || name.includes("hours") ;
    }) || [];
