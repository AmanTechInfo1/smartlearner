...
/* ========================================================================
   MAIN PAGE
   ======================================================================== */
export default function PdiPartTwoTraining() {
  ...
  useEffect(() => {
    dispatch(getCourseBySlug("instructor-training-part-two"));
  }, [dispatch]);
  ...
  const manualCategory = data.find((category) => category._id === "instructor training part two");
