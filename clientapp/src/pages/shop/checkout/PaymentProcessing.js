  ...
  return (
    <div className="payment-container">
      <form
        ...
        onSubmit={callFunApi}
      >
        <h1>Total Amount: {carting.total} £</h1>
        ...
        <input
          ...
          value={carting.ekashu_return_url}
        />
        <input
          type="hidden"
          name="ekashu_reference"
          value={carting.ekashu_reference}
        />
        <input
          type="hidden"
          name="ekashu_failure_url"
          value={carting.ekashu_failure_url}
        />
        <input
          type="hidden"
          name="ekashu_success_url"
          value={carting.ekashu_success_url}
        />
