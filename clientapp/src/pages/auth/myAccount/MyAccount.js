...
export default function MyAccount() {
  return (
    <div style={{backgroundColor:'black',fontFamily:"'Antonio', sans-serif",color:'white'}}>
     ...
     <div className="d-flex flex-column flex-md-row   rounded shadow-lg" style={{backgroundColor:'black',gap:'30px',padding:'5rem 2rem'}}>
      <div className="d-flex flex-column align-items-center bg-dark p-4 rounded shadow-md w-100 w-md-33" style={{justifyContent:'center'}}>
        <img
      ...
      <div className="d-flex flex-column bg-dark p-4 rounded shadow-md w-100 w-md-67 mt-4 mt-md-0 ml-md-4">
        ...
        <div className="d-flex justify-content-between mb-4">
          <span className="font-weight-semibold text-danger">Subscription</span>
          <span>current</span>
        </div>
