...
import { createQuiz, createQuizModule } from '../../../../redux/features/quizSlice';

const AddQuizUModuleModal = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        formDataToSend.append('moduleName', moduleName);
        // final_data={
        //     ...final_data,
        //     answer,
        //     category,
        ...
        dispatch(createQuizModule(formDataToSend, reset, props.toggleAddQuizCategoryModal, props.state));
        // setLoading(false);
        // // }
    };
...
export default AddQuizUModuleModal;
