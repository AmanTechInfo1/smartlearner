...
const EditQuizQuestionModal = (props) => {
  ...
  useEffect(() => {
    if (props.quizQuestion) {
      reset({
        question: props.quizQuestion.question,
        options: props.quizQuestion.options,
        correctOption: props.quizQuestion.correctOption,
        rightAnswer: props.quizQuestion.rightAnswer,
        image: null,
      });
    }
  }, [props.quizQuestion, reset]);
