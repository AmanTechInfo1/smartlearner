...
export default function AdminSidebar({ openSidebarToggle, OpenSidebar }) {
  return (
    <aside id={styles.adminSidebar} className={openSidebarToggle ? styles.sidebarResponsive : ''}>
      <div className={styles.adminSidebarTitle}>
        <div className={styles.adminSidebarBrand}>
          <FaUserTie className={`${styles.adminIcon} ${styles.adminIconHeader}`} /> Admin
        </div>
        <span className={`${styles.adminIcon} ${styles.adminCloseIcon}`} onClick={OpenSidebar}>X</span>
      </div>
      ...
      <ul className={styles.adminSidebarList}>
        ...
        <li className={styles.adminSidebarListItem}>
          <a href="">
            <BsListCheck className={styles.adminIcon} />Inventory
          </a>
        </li>
        <li className={styles.adminSidebarListItem}>
          <a href="">
            <BsMenuButtonWideFill className={styles.adminIcon} />Reports
          </a>
        </li>
        <li className={styles.adminSidebarListItem}>
          <a href="">
            <BsFillGearFill className={styles.adminIcon} />Setting
          </a>
        </li>
      </ul>
    </aside>
